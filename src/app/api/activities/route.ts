...
const VALID_ACTIVITIES = ["RUNNING","COFFEE_WALK","DRINKS","DOG_WALKING","HIKING","CYCLING","YOGA","DINNER","MUSEUM","PICNIC","DANCING","BRUNCH","LANGUAGE_EXCHANGE","CLIMBING","LIVE_MUSIC","NETWORKING"] as const;
